...
export default function ReportGenerator({ scanId, scanData }: ReportGeneratorProps) {
  ...
  return (
    <CollapsibleSection title="Executive Migration Readiness Report" defaultOpen={false}>
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-sm text-gray-600">
              Generate a comprehensive executive-level migration readiness summary with KPIs, risks, and leadership actions.
            </p>
          </div>
          ...
          <div className="border-2 border-blue-100 rounded-xl p-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 hover:shadow-xl hover:border-blue-200 transition-all duration-300">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Executive Readiness Summary</h3>
                <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                  A board-level summary highlighting migration health, key risks, and recommended leadership actions. Designed for C-suite decision-making.
                </p>
