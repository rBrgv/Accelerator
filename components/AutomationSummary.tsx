            ...
            <div className="space-y-4">
              {validationRulesArray.length > 0 ? (
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      <h3 className="text-sm font-medium text-blue-800">
                        Validation Rules Summary Available
                      </h3>
                      <div className="mt-2 text-sm text-blue-700">
                        <p>
                          We detected <strong>{validationRulesCount}</strong> validation rule{validationRulesCount !== 1 ? "s" : ""} in your org
                          {validationRulesActive !== null && validationRulesActive !== undefined ? (
                            <>, with <strong>{validationRulesActive}</strong> active</>
                          ) : null}.
                        </p>
                        <p className="mt-2">
                          Detailed validation rule information (names, formulas, error messages) is not available through the current API access. 
                          To view individual validation rules, use the Salesforce Setup UI or Metadata API.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border rounded-lg p-6 bg-gray-50 text-center">
                  <p className="text-gray-600">No validation rules found in this org.</p>
                </div>
              )}
            </div>
          )}
